      ...
      <>
        ...
        <div className="flex flex-col gap-1">
          <div className="flex sm:justify-between justify-between">
            <div className="flex justify-center sm:justify-start">
              <img
                className="w-20 h-20 sm:w-28 sm:h-28 rounded-full object-cover border-2 border-gray-300 cursor-pointer"
                src={
                ...
                {!isMobile && (
                  isOwnProfile ? (
                    ...
                    <button
                      ...
                      className="mt-2 px-4 py-1 rounded text-sm font-medium transition-colors bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 cursor-pointer"
                    >
                      Unfollow
                    </button>
                  ) : (
        ...
        {isMobile && (
          <div className="w-full mt-4">
            {isOwnProfile ? (
              <Link href={`/profile/${user.username}/edit`}>
                <button className="w-full py-3 rounded-lg text-sm font-medium bg-gray-700 text-white hover:bg-gray-600 transition shadow-lg cursor-pointer">
                  Edit Profile
                </button>
              </Link>
            ) : isFollowing ? (
              ...
              <button
                onClick={() => followMutation.mutate(user.id)}
                disabled={followMutation.isPending}
                className="w-full py-3 rounded-lg text-sm font-medium bg-blue-600 text-white hover:bg-blue-700 transition shadow-lg cursor-pointer"
              >
                Follow
              </button>
            )}
        ...
        <div className="flex justify-around mt-6">
          ...
          <Clapperboard size={28} className="cursor-pointer" />
