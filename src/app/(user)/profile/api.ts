...
async function getAllUsers() {
  ...
  const apiUrl = createApiUrl('/api/users/all-users');
  const { data } = await axios.get(apiUrl, config);
  return data;
}
...
export { UpdateProfile, GetProfileUsername, getAllUsers ,GetCurrentUser, SearchUserProfiel, followUser, UnfollowUser };
