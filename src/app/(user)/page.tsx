  ...
  return (
    <div className="w-full justify-items-center bg-black min-h-screen">
      ...
      <div className="relative w-[450px] bg-black py-4">
        <button
          onClick={scrollLeft}
          className="hidden md:flex absolute left-2 top-15 transform -translate-y-1/2 z-10 w-8 h-8 rounded-full shadow text-black bg-white items-center justify-center cursor-pointer"
        >
        ...
        <button
          onClick={scrollRight}
          className="hidden md:flex absolute right-0  top-15 transform -translate-y-1/2 z-10 w-8 h-8 rounded-full shadow text-black bg-white items-center justify-center cursor-pointer "
        >
            ...
            <div key={post.id} className="mb-8 border-b border-gray-800 pb-6">
              ...
              <div className="flex items-center justify-between px-4 py-3">
                <div className="flex gap-4">
                  ...
                  <button className="text-white transition-transform hover:scale-110 cursor-pointer">
              ...
              <div className="px-4 ">
                ...
                <div className="text-gray-300 text-sm w-[450px]">
                  {showFull[post.id] ? post.caption : shortText}
                  {isTruncated && (
                    <button
                      onClick={() => toggleShow(post.id)}
                      className="text-gray-400 ml-1 zhover:text-white cursor-pointer"
                    >
